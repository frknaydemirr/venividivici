...
async def get_user_questions_from_subscriptions(request: Request):
    ...
    questions = request.app.ctx.db.get_questions_from_subscriptions(user_id=user_id, offset=offset, limit=limit)
...
async def get_user_city_subscriptions(request: Request):
    ...
    cities = request.app.ctx.db.get_subscribed_cities(user_id=user_id)
...
async def post_user_city_subscription(request: Request):
    ...
    request.app.ctx.db.post_subscribe_city(user_id=user_id, city_id=city_id, subscription_type=subscription_type)
...
async def get_user_country_subscriptions(request: Request):
    ...
    countries = request.app.ctx.db.get_subscribed_countries(user_id=user_id)
...
async def post_user_country_subscription(request: Request):
    ...
    request.app.ctx.db.post_subscribe_country(user_id=user_id, country_id=country_id, subscription_type=subscription_type)
